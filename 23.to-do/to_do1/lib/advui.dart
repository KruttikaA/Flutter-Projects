...
Future<void> showBottomSht(bool doEdit, [ToDoModelClass? todoModelObj]) async {
...
"Title",
style: GoogleFonts.quicksand(
color: const Color.fromRGBO(89, 57, 241,
1),
...
backgroundColor: const Color.fromRGBO(89, 57,
241, 1),
),
onPressed: () {
...
color: const Color.fromRGBO(255,
255, 255, 1),
border: Border.all(
color:
const Color.fromRGBO(0,
0, 0, 0.05),
width: 0.5),
boxShadow: const [
BoxShadow(
